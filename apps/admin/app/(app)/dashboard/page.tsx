...
// cache, the rail, the palette and the `g` sequence, so what is left for a
// route file is naming the screen it draws. Everything the dashboard does needs
// the browser — a cache, a session token held in memory — so the screen itself
