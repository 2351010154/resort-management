...
//
// A shell around one component and nothing else, like the queues beside it:
...
// Everything the screen does needs the browser: a cache, a session token held
// in memory, focus moving between rows and into a form. The screen is a client
