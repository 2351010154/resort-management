...
import { roomScrollTarget } from "@/features/arrival/components/act-4-stay/room-orbit";
...
/**
 * Land on one room of Act 4's orbit. Stay / Dine / Restore all live inside Act 4
 * now, so they need distinct offsets within it rather than one shared anchor.
 * The reduced-motion variant has no orbit to aim at; that falls back to the act.
 */
