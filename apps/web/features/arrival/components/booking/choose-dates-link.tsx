...
// One address for every chapter that has something to say and nothing to prove.
//
...
// sentence they can do nothing with. The chapter can still hand over the one
// thing that is true and actionable: the stay itself. This is that link, and it
// carries whatever the page's draft already holds — a range typed into the rail
// or into chapter 7 arrives with it, an empty one lands on the calendar with the
// party intact. Same rule as the deck's `Book your stay`: an address cannot
// refuse to navigate, so it never validates.
//
